...
model = joblib.load("/Users/mansurjonovnurmuhammad/Desktop/model.pkl")

# Load the model accuracy
with open("/Users/mansurjonovnurmuhammad/Desktop/accuracy.txt", "r") as f:
    accuracy = f.read()
...
for feature in feature_names:
    if feature in ["manufacturer", "model", "category", "fuel_type", "color"]:
